...
try {
    ...
    foreach (['my', 'shared', 'team'] as $_dsKey) {
        if (!empty($allDatasets[$_dsKey]) && is_array($allDatasets[$_dsKey])) {
            $allDatasets[$_dsKey] = array_map('sc_redact_dataset_urls_for_client', $allDatasets[$_dsKey]);
        }
    }
