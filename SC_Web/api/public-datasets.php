...
try {
    ...
    if (!empty($response['datasets']['public']) && is_array($response['datasets']['public'])) {
        $response['datasets']['public'] = array_map('sc_redact_dataset_urls_for_client', $response['datasets']['public']);
    }
