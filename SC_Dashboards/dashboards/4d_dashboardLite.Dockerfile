...
CMD ["sh", "-c", "python3 -m bokeh serve ./4d_dashboardLite.py --allow-websocket-origin=$DOMAIN_NAME --allow-websocket-origin=127.0.0.1 --allow-websocket-origin=0.0.0.0 --port=8056 --address=0.0.0.0 --use-xheaders --session-token-expiration=86400"]
